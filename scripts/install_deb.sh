...
# 依赖 hassos-supervisor.service，并在脚本内部循环等待 supervisor.sock
# 与 end0 IPv4 就绪；失败后 systemd 自动重试。另配 NM dispatcher
# /etc/NetworkManager/dispatcher.d/99-hassos-dns-cn 作为双保险。
